...
const DEFAULT_PRIORITIES: Record<ExtendedNotificationTypeEnum, NotificationPriorityEnum> = {
  ...
  tournament_registration_closing_soon: 'high',
  tournament_match_ready: 'high',
  tournament_deadline_changed: 'normal',
  tournament_round_deadline_soon: 'high',
  tournament_deadline_extended: 'high',
  tournament_match_walkover: 'high',
  tournament_match_cancelled: 'normal',
  tournament_dispute_escalated: 'high',
  ...
  session_cancelled: 'urgent',
  season_cancelled: 'urgent',
...
const TITLE_TEMPLATES: Record<ExtendedNotificationTypeEnum, string> = {
  ...
  recurring_court_opened: 'Courts just opened at {facilityName}',
  ...
  tournament_registration_open: 'Registration is open · {tournamentName}',
  tournament_registration_closing_soon: 'Last chance · {tournamentName}',
...
const BODY_TEMPLATES: Record<ExtendedNotificationTypeEnum, string> = {
  ...
  recurring_court_opened:
    'Booking just opened for your recurring game. Lock in your court before it goes.',
  ...
  tournament_registration_open: 'Spots are limited. Tap to register.',
  tournament_registration_closing_soon:
    'Registration closes soon and spots are limited. Tap to register.',
  ...
  session_cancelled: '{sessionName} has been cancelled.',
  season_cancelled: '{seasonName} has been cancelled.',
