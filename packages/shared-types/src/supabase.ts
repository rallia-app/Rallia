  ...
  public: {
    Tables: {
      ...
      lt_registration_payment: {
        Row: {
          ...
          status: Database["public"]["Enums"]["lt_payment_status_enum"]
          stripe_charge_id: string | null
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "lt_registration_payment_payer_user_id_fkey"
          ...
          {
            foreignKeyName: "lt_registration_payment_tournament_registration_id_fkey"
      ...
      match_interest: {
        ...
        Relationships: [
          {
            foreignKeyName: "match_interest_match_id_fkey"
            columns: ["match_id"]
            isOneToOne: false
            referencedRelation: "match"
            referencedColumns: ["id"]
      ...
      network_member: {
        Row: {
          ...
          player_id: string
          request_type:
            | Database["public"]["Enums"]["network_member_request_type"]
            | null
      ...
      organizer_fee_override: {
        ...
        Relationships: [
          {
            foreignKeyName: "organizer_fee_override_organizer_id_fkey"
            columns: ["organizer_id"]
            isOneToOne: true
            referencedRelation: "player"
            referencedColumns: ["id"]
      ...
      peer_rating_request: {
        ...
        Relationships: [
          {
            foreignKeyName: "peer_rating_request_evaluator_id_fkey"
          ...
          {
            foreignKeyName: "peer_rating_request_requester_id_fkey"
      ...
      player_favorite_facility: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "player_favorite_facility_sport_id_fkey"
            columns: ["sport_id"]
            isOneToOne: false
            referencedRelation: "sport"
            referencedColumns: ["id"]
      ...
      player_interest: {
        Row: {
          created_at: string | null
          email: string
          favorite_pickleball_facility_custom: string | null
          favorite_pickleball_facility_id: string | null
          favorite_tennis_facility_custom: string | null
          favorite_tennis_facility_id: string | null
          first_name: string
          id: number
          ip_address: string | null
          last_name: string
          location: string | null
          pickleball_rating_score_id: string | null
          plays_pickleball: boolean
          plays_tennis: boolean
          postal_code: string
          tennis_rating_score_id: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "player_interest_favorite_pickleball_facility_id_fkey"
            columns: ["favorite_pickleball_facility_id"]
            isOneToOne: false
            referencedRelation: "facility"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "player_interest_favorite_tennis_facility_id_fkey"
            columns: ["favorite_tennis_facility_id"]
            isOneToOne: false
            referencedRelation: "facility"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "player_interest_pickleball_rating_score_id_fkey"
            columns: ["pickleball_rating_score_id"]
            isOneToOne: false
            referencedRelation: "rating_score"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "player_interest_tennis_rating_score_id_fkey"
            columns: ["tennis_rating_score_id"]
            isOneToOne: false
            referencedRelation: "rating_score"
            referencedColumns: ["id"]
          },
      ...
      proof_report: {
        Row: {
          ...
          priority: string | null
          proof_id: string
          reason: Database["public"]["Enums"]["proof_report_reason_enum"]
          reporter_id: string
          reviewed_at: string | null
          reviewed_by: string | null
          status: Database["public"]["Enums"]["report_status_enum"]
        ...
        Relationships: [
          {
            foreignKeyName: "proof_report_proof_id_fkey"
            columns: ["proof_id"]
            isOneToOne: false
            referencedRelation: "rating_proof"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "proof_report_reporter_id_fkey"
            columns: ["reporter_id"]
            isOneToOne: false
            referencedRelation: "profile"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "proof_report_reviewed_by_fkey"
            columns: ["reviewed_by"]
            isOneToOne: false
            referencedRelation: "admin"
            referencedColumns: ["id"]
      ...
      reference_request: {
        ...
        Relationships: [
          {
            foreignKeyName: "reference_request_claimed_rating_score_id_fkey"
            columns: ["claimed_rating_score_id"]
            isOneToOne: false
            referencedRelation: "rating_score"
            referencedColumns: ["id"]
          },
          ...
          {
            foreignKeyName: "reference_request_reference_rating_score_id_fkey"
            columns: ["reference_rating_score_id"]
            isOneToOne: false
            referencedRelation: "rating_score"
            referencedColumns: ["id"]
          },
          ...
          {
            foreignKeyName: "reference_request_sport_id_fkey"
            columns: ["sport_id"]
            isOneToOne: false
            referencedRelation: "sport"
            referencedColumns: ["id"]
      ...
      session_matches: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "session_matches_match_id_fkey"
            columns: ["match_id"]
            isOneToOne: true
            referencedRelation: "match"
            referencedColumns: ["id"]
      ...
      web_join: {
        ...
        Relationships: [
          {
            foreignKeyName: "web_join_match_id_fkey"
            columns: ["match_id"]
            isOneToOne: false
            referencedRelation: "match"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "web_join_player_id_fkey"
            columns: ["player_id"]
            isOneToOne: false
            referencedRelation: "player"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_compat_supply_snapshot: {
        Args: never
        Returns: {
          compatible_mean: number
          compatible_median: number
          density_mean: number
          density_median: number
          density_p25: number
          density_p75: number
          goal_bucket: string
          pct_played_any: number
          pct_played_compatible: number
          pct_zero_density: number
          played_compatible_mean: number
          played_mean: number
          players: number
      ...
      lt_run_session_sheet: {
        Args: { p_action: string; p_session_id: string; p_version_was: number }
        Returns: {
          allow_guests: boolean
          cancelled_at: string | null
          cancelled_reason: string | null
      ...
      resolve_service_fee_policy: {
        Args: {
          p_event_cap_cents?: number
          p_event_flat_cents?: number
          p_event_pct_bps?: number
      ...
      session_confirm_presence: {
        Args: {
          p_partner_id?: string
          p_session_id: string
          p_status: Database["public"]["Enums"]["session_presence_status"]
        }
        Returns: {
          created_at: string
          guest_invited_by: string | null
      ...
      session_record_score: {
        Args: {
          p_score?: string
          p_session_match_id: string
          p_status?: Database["public"]["Enums"]["session_match_status"]
          p_version_was?: number
          p_winner_team: Database["public"]["Enums"]["pairing_team"]
        }
        Returns: {
          court_id: string | null
          court_label: string | null
      ...
      tournament_reopen_registration: {
        Args: { p_tournament_id: string; p_version_was: number }
        Returns: {
          archived_at: string | null
          bracket_locked_at: string | null
    ...
    Enums: {
      ...
      facility_type_enum:
        ...
        | "school"
        | "community_center"
      fee_payer_enum: "player_pays" | "organizer_absorbs"
      ...
      payout_timing_enum: "hold_until_event_end" | "pay_as_you_go"
      play_attribute_enum:
      ...
      rating_system_code_enum:
        ...
        | "dupr"
        | "self_pickle"
      refund_policy_kind_enum: "full" | "partial" | "none"
