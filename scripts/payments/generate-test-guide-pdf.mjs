#!/usr/bin/env node
/**
 * Regenerates Guide_de_test_des_paiements.pdf from scripts/payments/test-guide.html
 *
...
const PDF_PATH = path.join(__dirname, '..', '..', 'docs', 'Guide_de_test_des_paiements.pdf');
