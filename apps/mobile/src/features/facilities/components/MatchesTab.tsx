...
export default function MatchesTab({ facilityId }: MatchesTabProps) {
  ...
  const renderEmptyComponent = useCallback(() => {
    ...
    return (
      <EmptyState
        ...
        title={t(
          hasActiveFilters ? 'publicMatches.empty.title' : 'publicMatches.empty.noFilters.title'
        )}
        description={t(
          hasActiveFilters
  ...
  }, [isLoading, isSearching, hasActiveFilters, colors.primary, selectedSport?.name, t]);
