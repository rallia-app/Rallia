...
Sentry.init({
  ...
  // TEMP (debug/sentry-instrumentation-android): disable HTTP/replay instrumentation
  // to test whether @sentry/react-native@7.11.0's XHR wrapping is breaking the IC3
  // POST request on Android in release/preview builds. Restore once diagnosed.
  tracesSampleRate: 0,
  replaysOnErrorSampleRate: 0,
  replaysSessionSampleRate: 0,
  integrations: [
    sentryNavigationIntegration,
    // Removed mobileReplayIntegration — it instruments network on the native side.
  ],
