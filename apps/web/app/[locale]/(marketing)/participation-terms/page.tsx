...
import { participationTerms } from './participation-terms-content';
...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    ...
    namespace: 'seo.participationTerms',
  });
}

export default async function ParticipationTermsPage({
  params,
}: {
  params: Promise<{ locale: Locale }>;
}) {
  ...
  const content = (participationTerms[locale] ?? participationTerms[defaultLocale]).replaceAll(
    '](/',
    `](/${locale}/`
  );
