-- ============================================================================
-- Leagues — V9 session match bridge REPAIR (re-run of 20260628190000)
-- ============================================================================
-- Staging recorded version 20260628190000 as applied but none of its objects
-- exist there (no session_matches.match_id column, no session_attach_match
-- RPC) — the classic consumed-version-without-execution state. Every statement
-- in the original is idempotent (IF NOT EXISTS / CREATE OR REPLACE), so this
-- migration re-runs it verbatim: a no-op where the bridge already exists,
-- a heal where it doesn't. Do not edit 20260628190000 itself.
-- ============================================================================
