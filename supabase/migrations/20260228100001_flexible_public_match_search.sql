-- ============================================================================
-- Migration: Flexible public match search
-- Created: 2026-02-28
-- Description: Replaces the simple LOWER/LIKE text search in search_public_matches
--   with word-tokenized, accent-insensitive matching using extensions.unaccent.
--   "montreal" now matches "Montréal", "tennis park" matches "Park Tennis Club",
--   and extra whitespace is handled gracefully.
--   The unaccent extension is already enabled from migration 20260228100000.
-- ============================================================================
...
COMMENT ON FUNCTION search_public_matches(
  DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, DATE, INT, INT, TEXT, UUID
) IS 'Search public matches with comprehensive filters including word-tokenized accent-insensitive text search, duration, court status, specific date, and facility. Always filters out matches that have already started today and full matches. Uses gender_enum for proper gender comparison.';
