-- =============================================================================
-- Migration: Update feedback notification trigger to include metadata and module
-- Description: Pass NEW.metadata and NEW.module in the JSONB payload sent to
--              the send-feedback-notification Edge Function so it can render
--              category-specific fields in the admin email.
-- =============================================================================
