-- ============================================================================
-- Migration: Update public match search filters
-- Created: 2026-05-03
-- Description:
--   1. Cost filter: expand from free/paid to per-player cost ranges
--      (free, under_5, under_10, under_20, 20_plus). Per-player cost is
--      computed as estimated_cost / total_spots (4 for doubles, 2 otherwise).
--   2. Reputation filter: new p_reputation_tier parameter to filter matches
--      by the host's reputation tier (bronze, silver, gold, platinum).
--   3. Rating filter: new p_rating_score_ids parameter to filter matches
--      whose min_rating_score_id is one of the selected rating scores.
-- ============================================================================
