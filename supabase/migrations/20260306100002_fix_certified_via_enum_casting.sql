-- Migration: Fix certified_via enum type casting
-- Description: The reevaluate_certification_for_player_rating function was assigning text to 
--              rating_certification_method_enum column. This fixes by casting to the proper enum type.
-- Created: 2026-03-06

-- ============================================================================
-- 1. FIXED FUNCTION: Re-evaluate certification with proper enum casting for all enums
-- ============================================================================
