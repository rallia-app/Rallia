-- ============================================================================
-- Migration: Fix admin delete network function
-- Description: Fixes the admin table reference (admin, not admin_user)
-- ============================================================================

-- Drop the existing function
DROP FUNCTION IF EXISTS admin_delete_network(UUID, TEXT);

-- Recreate with correct admin table reference
...
COMMENT ON FUNCTION admin_delete_network(UUID, TEXT) IS 
  'Admin function to delete a network with member notifications - FIXED: uses admin table';
