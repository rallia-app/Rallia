-- Migration: Add organization nature to facility search results
-- Exposes the parent organization's nature (public/private) so the mobile app
-- can display a badge distinguishing public from private facilities.
