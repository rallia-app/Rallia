-- ============================================
-- Doubles tournaments — allow doubles/mixed_doubles at creation
-- ============================================
-- Removes the entry_format guard added in 20260527000300 (and carried into
-- 20260612090100): the partner registration flow now ships
-- (20260612160200), so non-singles tournaments are playable end-to-end.
-- mixed_doubles is a label only — no gender validation.
--
-- Body is the 20260612090100 tournament_create verbatim (registration_closes_at
-- defaulting included) minus the DOUBLES_NOT_SUPPORTED guard. For doubles,
-- max_participants counts ENTRIES (teams), unchanged semantics — capacity,
-- bracket sizing and seeding already operate on registrations.
-- ============================================
