-- Migration: Add favorite-first sorting to facility search
-- Description: Adds p_player_id parameter so the search can LEFT JOIN
--              player_favorite_facility and sort favorites to the top.
...
BEGIN
  ...
  FROM (
    SELECT
      ...
      -- A facility is favorite if the player has favorited it for any of the requested sports
