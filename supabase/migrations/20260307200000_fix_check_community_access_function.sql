-- Migration: Recreate check_community_access function
-- The function was dropped during remote schema sync and needs to be recreated
-- with proper TEXT type casting to avoid type mismatch errors
...
DO $$
BEGIN
  RAISE NOTICE 'check_community_access function recreated with proper TEXT type casting';
END $$;
