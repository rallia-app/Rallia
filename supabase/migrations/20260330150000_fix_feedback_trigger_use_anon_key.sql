-- =============================================================================
-- Migration: Fix feedback notification trigger to use anon_key
-- Description: The trigger was using service_role_key from Vault, but the edge
--              function validates against SUPABASE_ANON_KEY. All other working
--              triggers (send-notification, send-email) use anon_key. This
--              aligns the feedback trigger with that pattern.
-- =============================================================================
...
BEGIN
  ...
  -- Call the Edge Function asynchronously via pg_net (using anon_key)
