-- =============================================================================
-- Announcement branding: use the 📣 megaphone in both push + conversation title
--
-- 20260724210000 set the announcement push title to "📢 Rallia". Product wants
-- the golden megaphone "📣" instead, and the same glyph on the conversation
-- title so the channel reads "📣 Rallia" in the inbox. Everything else in
-- notify_new_message is unchanged from 20260724210000.
-- =============================================================================
...
-- Prefix the announcement channel title with the same glyph so it reads
-- "📣 Rallia" in the inbox. Guarded so re-runs are idempotent.
UPDATE public.conversation
SET title = '📣 Rallia', updated_at = now()
