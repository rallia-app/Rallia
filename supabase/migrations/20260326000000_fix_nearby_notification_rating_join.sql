-- Fix: notify_nearby_players_on_match_created() references dropped "rating" table
-- The old "rating" table was dropped in 20251212000002_drop_old_rating_table.sql
-- and replaced by "rating_system". The rating_score FK column was also renamed
-- from "rating_id" to "rating_system_id".
