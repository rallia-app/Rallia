-- ============================================================================
-- Match Organizer: carry fav_count into the card snapshot
-- ============================================================================
-- The engine has always computed fav_count, the number of the card's players who
-- favourited that facility for the sport, and every step downstream threw it
-- away. It is the one signal that says "this is a court you BOTH already play
-- at", which is stronger evidence a slot will actually happen than any court
-- feed, and the card could not show it.
--
-- Snapshotting it lets the card mark a shared favourite. A value equal to the
-- participant count means everyone favourites it; lower means only some do.
-- ============================================================================
