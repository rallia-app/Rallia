-- =============================================================================
-- Migration: Add 'social' to referral_invitation_type
-- Description: Extends channel attribution to cover social media campaigns
-- (Facebook, Instagram, etc.). Like flyer/poster, social has no referring user.
-- =============================================================================
...
ALTER TABLE public.profile
  ...
  CHECK (referral_invitation_type IN ('referral', 'match', 'group', 'community', 'flyer', 'poster', 'social'));
...
ALTER TABLE public.referral_link_click
  ...
  CHECK (invitation_type IN ('referral', 'match', 'group', 'community', 'flyer', 'poster', 'social'));
