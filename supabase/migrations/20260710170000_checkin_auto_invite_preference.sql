-- =============================================================================
-- Weekly check-in plan preview: expose auto_invite_players separately from
-- auto_create_matches so the wizard can toggle them independently.
-- =============================================================================
...
COMMENT ON FUNCTION public.get_checkin_match_plan(jsonb, smallint, text, int) IS
  'Check-in wizard plan PREVIEW: up to 10 ranked proposals plus separate '
  'opted_out (auto_create_matches) and auto_invite_enabled preferences.';
