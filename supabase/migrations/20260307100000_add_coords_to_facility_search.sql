-- Add latitude and longitude to search_facilities_nearby return type
-- so the map view can plot facility markers without an extra query.

-- Drop without signature to catch any overload
