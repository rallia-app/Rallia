-- ============================================================================
-- Leagues & Tournaments — min_rating at creation
-- ============================================================================
-- Lets the organizer set the minimum required level when creating a tournament
-- (previously edit-only), completing the "specify min level" half of the soft
-- gate. Body is the 20260622120400 tournament_create verbatim plus a trailing
-- p_min_rating param and its insert. Adding a param changes the signature, so
-- drop the old 18-arg version first (else PostgREST sees two candidates) and
-- re-grant (DROP loses grants).
-- ============================================================================
