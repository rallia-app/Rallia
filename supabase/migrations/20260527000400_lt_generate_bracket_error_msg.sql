-- ============================================
-- Fix: accurate error code when bracket can't be generated
-- ============================================
-- tournament_generate_bracket requires status = 'registration_closed', but
-- raised 'TOURNAMENT_NOT_DRAFT' when the status was anything else — a
-- copy-paste leftover that misleads (the tournament is past draft, not
-- stuck in it). Rename to 'TOURNAMENT_NOT_READY'.
--
-- Nothing in the app keys off the old string (verified by grep); only this
-- RPC raised it. Body is otherwise verbatim from 170012.
-- ============================================
