-- ============================================================================
-- Sport announcement channels in the inbox RPCs
--
-- Base text: 20260613100200_conversation_rpcs_tournament.sql (latest).
-- Additions, applied to both RPCs:
--   - visibility gate includes announcement conversations (they surface before
--     the first message, like match and tournament chats)
--   - sport filter respects conversation.sport_id, so a player of both sports
--     filtering by tennis does not see the pickleball channel
--   - filtered RPC: 'announcement' filter value
-- ============================================================================
