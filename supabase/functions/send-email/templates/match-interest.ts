...
export function renderMatchInterestEmail(payload: MatchInterestEmailPayload): EmailContent {
  ...
  const content = `
                <h2 style="margin: 0; padding: 0 0 8px 0; font-family: Poppins, Arial, Helvetica, sans-serif; font-size: 28px; font-weight: 800; color: ${EMAIL_TOKENS.neutral900}; letter-spacing: -0.03em; line-height: 1.2;">
