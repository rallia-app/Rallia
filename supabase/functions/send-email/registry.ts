...
import { WelcomeHandler } from './handlers/welcome.ts';
import type {
  EmailContent,
  EmailRequest,
  EmailType,
...
export function isWelcomeRecord(request: EmailRequest): request is WelcomeRecord {
  return request.emailType === 'welcome';
}
